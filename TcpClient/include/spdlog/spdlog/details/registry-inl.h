    ...
    : formatter_(new pattern_formatter())
{
    ...
    default_logger_ = std::make_shared<joyinlog::logger>(default_logger_name, std::move(color_sink));
...
// To be used directly by the spdlog default api (e.g. joyinlog::info)
