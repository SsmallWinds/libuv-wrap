...
public:
    //
    systemd_sink()
        : syslog_levels_{{/* joyinlog::level::trace      */ LOG_DEBUG,
              /* joyinlog::level::debug      */ LOG_DEBUG,
              /* joyinlog::level::info       */ LOG_INFO,
              /* joyinlog::level::warn       */ LOG_WARNING,
              /* joyinlog::level::err        */ LOG_ERR,
              /* joyinlog::level::critical   */ LOG_CRIT,
              /* joyinlog::level::off        */ LOG_INFO}}
    {}
