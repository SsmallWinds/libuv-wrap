...
public:
    ...
    void swap(joyinlog::logger &other) SPDLOG_NOEXCEPT;
    ...
    void log(source_loc loc, level::level_enum lvl, string_view_t fmt, const Args &... args)
    {
        ...
        {
            memory_buf_t buf;
            joyinfmt::format_to(buf, fmt, args...);
    ...
    template<class T, typename std::enable_if<std::is_convertible<const T &, joyinlog::string_view_t>::value, T>::type * = nullptr>
    ...
    template<class T, typename std::enable_if<!std::is_convertible<const T &, joyinlog::string_view_t>::value &&
...
#error SPDLOG_WCHAR_TO_UTF8_SUPPORT only supported on windows
    ...
    void log(source_loc loc, level::level_enum lvl, wstring_view_t fmt, const Args &... args)
    {
        ...
        SPDLOG_TRY
        {
            ...
            joyinfmt::wmemory_buffer wbuf;
            joyinfmt::format_to(wbuf, fmt, args...);
...
protected:
    ...
    joyinlog::level_t level_{level::info};
    joyinlog::level_t flush_level_{level::off};
